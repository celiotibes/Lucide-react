...
**Conflito para você decidir, não resolvido sozinho**: o Anexo III, item B.2 ("Câmeras e Privacidade") diz que é **"vedada a solicitação de imagens por inquilinos para fins particulares, exceto sob ordem judicial ou policial."** Isso contradiz diretamente o pedido de construir um fluxo de "pedido de imagens de câmeras de segurança" com aprovação manual do admin (a resposta que você já tinha dado nesta conversa) — pelo contrato assinado, o admin não teria nem autoridade contratual para liberar a pedido do inquilino, só mediante ordem judicial/policial. Preciso que você confirme: o regulamento vai ser alterado para permitir pedido direto (com aprovação do admin como salvaguarda), ou o fluxo certo é diferente — abrir um chamado que só serve para *encaminhar* o pedido à via judicial/policial, sem nunca liberar a imagem diretamente pelo sistema?
