  ...
  return (
    <>
      ...
      <p className="section-hint">
        No máximo um modelo ativo por cidade — cadastrar um novo modelo para uma cidade desativa automaticamente o
        anterior, sem apagar contratos já gerados com ele.
      </p>
      {modelos.length === 0 ? (
