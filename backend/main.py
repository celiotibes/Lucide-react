...
from routes import processos, calculos, rag, multi_tier_llm, advanced_research
...
app.include_router(advanced_research.router)  # Advanced Research com RAG + 4-Tier
