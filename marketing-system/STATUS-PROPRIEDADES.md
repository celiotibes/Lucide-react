...
**Última atualização**: 23 de agosto de 2026, 08:45  
...
- 💰 Preço base: R$ 1.850–2.800/mês
- ⭐ Diferenciais: Proximidade UFSC, ambiente silencioso, áreas comuns bem estruturadas
...
## 📊 Dados Integrados no CRMT

✅ **Landing Page** — Atualizada com preços e descrições reais  
✅ **Dashboard** — Métricas por propriedade (em tempo real via IMPORTRANGE)  
✅ **AppsScript** — Funções automáticas para:
  - SLA de resposta (10 min)
  - Follow-ups 24–48h
  - Sincronização reversa (lead fechado → status atualizado)
  - Alertas de review (15 dias após locação)

✅ **Logs** — Registro de cada ação automatizada

---

## 🔄 Próximos Passos

1. **Deploy em produção** → Landing page com dados reais
2. **Monitoramento** → Dashboard CRMT capturando leads em tempo real
3. **Automação** → AppsScript enviando alertas e gerando follow-ups
4. **Relatórios** → Análise semanal de performance por canal

---

**Responsável**: RMT Gestão  
**Sistema**: CRMT Marketing e Anúncios v2.1  
